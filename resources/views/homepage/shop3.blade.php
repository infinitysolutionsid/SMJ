...
@section('title','| Produk Sparepart Mobil')
@section('keywords','hydraulic dump truck','Sparepart Mobil','hydraulic')
@section('desc','Halaman ini menjual berbagai produk Sparepart Mobil dari Sumber Diesel.')
@section('content')
<section id="page-title">
    <div class="container">
        <div class="page-title">
            <h1>Sparepart Mobil</h1>
        </div>
        <div class="breadcrumb">
            <ul>
                ...
                <li class="active"><a href="/sparepart-mobil">Sparepart Mobil</a>
                </li>
            </ul>
        </div>
    </div>
            ...
            <div class="content col-lg-8">
                <div class="row m-b-20">
                    <div class="col-lg-8 p-t-10 m-b-20">
                        <h3 class="m-b-20">Sparepart Mobil</h3>
