            ...
            <div class="row">
                <div class="col-lg-5">
                    <div class="carousel" data-items="1">
                        <img src="{!!asset('storage/shop/hydraulic/hy-2.jpg')!!}" alt="Shop product image!">
                        <img src="{!!asset('storage/shop/hydraulic/hy-2.jpg')!!}" alt="Shop product image!">
                    </div>
                </div>
                <div class="col-lg-7">
                    <div class="product-description">
                        ...
                        <div class="product-meta">
                            <p>Tags: <a rel="tag" href="#">Spareparts</a>, <a href="#" rel="tag">Hydraulic</a>
                            </p>
                        </div>
                    ...
                    <div class="m-t-20">
                        <button class="btn btn-lg" type="button">Add to cart</button>
                    </div>
                </div>
            </div>
        </div>
